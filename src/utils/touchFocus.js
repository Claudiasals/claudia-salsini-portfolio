const INTERACTIVE_SELECTOR =
  'a, button, .nav-btn, .btn-primary, .btn-secondary, .contact-detail-link, .contact-form-input-wrap, .projects-carousel-dot, .project-detail-back, .legal-page__email, .site-footer__link'
